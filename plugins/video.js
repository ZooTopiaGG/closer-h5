  ...
  bind: function (el, binding, vnode) {
    ...
    */
    ...
    Array.prototype.forEach.call(vm.video, (x, i) => {
      ...
      x.nextSibling.querySelector('.video-poster').onclick = (function () {
        return function () {
          vm.index = i;
          vm.playVideo();
        };
      })(i);
      x.nextSibling.querySelector('.video-playing').onclick = (function () {
        return function () {
          vm.index = i;
          vm.pauseVideo();
        };
      })(i);
      x.nextSibling.querySelector('.video-pause').onclick = (function () {
        return function () {
          vm.index = i;
          vm.playPauseVideo();
        };
      })(i);
      x.nextSibling.querySelector('.v2-controls').ontouchmove = (function () {
        return function () {
          vm.index = i;
          vm.touchmove();
        };
      })(i);
      x.nextSibling.querySelector('.v2-launchFullScreen').onclick = (function () {
        return function () {
          vm.index = i;
