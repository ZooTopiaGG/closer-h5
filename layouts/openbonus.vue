  ...
  <div id="openbonus">
    ...
    <div class="openbonus-body flex flex-v flex-align-center">
      <div class="body-avatar">
        <img src="~/assets/images/btn_open@2x.png">
      </div>
      <div class="body-desc"><span>海哥</span>给你发了</div>
    ...
    如果已经领取了 则显示给其他好友发红包 -->
    <div class="openbonus-sign" v-if="!isWeiXin && !hasToken">
      <dp-login :isAbsolute="false"></dp-login>
    </div>
    <div v-else>
      <mt-button type="primary" class="margin-top-20 tj-btn">
        <span v-if="isWeiXin && $route.query.code">立即下载，提现无门槛</span>
        <span v-else>给其他好友发红包</span>
      </mt-button>
    </div>
    <div class="openbonus-footer">
